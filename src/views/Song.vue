...
<script>
import { songsCollection, auth, commentsCollection, db } from "@/includes/firebase";
import { doc, getDocs, getDoc, addDoc, updateDoc, query, where } from "firebase/firestore";
